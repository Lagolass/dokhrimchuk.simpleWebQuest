package com.javarush.dokhrimchuk.simplewebquest.bundle;
...
public class Text extends ResourceBundle {
    ...
    private static final String TEXT_BASE_NAME = "quest";

    private Text(Locale locale) {
        setLocale(locale);
    }

    public static Text setFor(HttpServletRequest request) {
        ...
        return getCurrentInstance(request);
    }
